...
public class MomentumServiceClient
{
    ...
    {
        String dataInput = "{\"id\" : 21,\"ssn\" : \"11-111-11112\",\"name\" : \"Arbind\", \"gender\" : \"M\",\"age\" : null,\"languages\" : null,"
                           + "\"disabilities\" : null,\"mobility\" : null,\"employmentStatus\" : \"Y\",\"address\" : null,\"phoneNumber\" : null,\"skillsandAptitudes\" : null,"
                           + "\"gradeLevel\" : null,\"read\" : \"y\",\"write\" : \"y\",\"role\" : \"admin\",\"firstName\" : \"Arbind\",\"lastName\" : \"Jain\","
        ...
        System.out.println(dataInput);*/
        System.out.println(dataInput);
        String responseString = (String) new MomentumServiceClient().callMomentumServicePost("http://localhost:8080/MomentumService/momentum/user", dataInput);
