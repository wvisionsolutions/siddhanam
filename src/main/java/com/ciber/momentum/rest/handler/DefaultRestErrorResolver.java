 ...
 */
package com.ciber.momentum.rest.handler;
...
public class DefaultRestErrorResolver implements RestErrorResolver, MessageSourceAware, InitializingBean
{
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(DefaultRestErrorResolver.class);
