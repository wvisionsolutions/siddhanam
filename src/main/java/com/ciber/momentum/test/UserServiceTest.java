...
public class UserServiceTest {
	...
	public void setUp() throws Exception {
		...
		userResponseList = userDAO.searchUsers(searchUser);
		Iterator<UserResponse> itr = userResponseList.iterator();
		while (itr.hasNext()) {
			userResponse = itr.next();
			actualSearchFirstName = userResponse.getFirstName();
			System.out.println("actualSearchFirstName ---- "
					+ actualSearchFirstName);
		...
		// to edit the user
		updateUser = new User();
		updateUser.setFirstName("sunee");
		updateUser.setLastName("p");
		updateUser.setGender("F");
		updateUser.setPassword("sasdsd");
		updateUser.setSsn("111-22-444");
		updateUser.setName("suneetha");
		updateUser.setEmail("A@gmail.com");
		updateUser.setRole("Basic");

		updateUserUnvalid = new User();
		updateUserUnvalid.setFirstName("sunee");
		updateUserUnvalid.setLastName("p");
		updateUserUnvalid.setGender("F");
	...
	public void testUserDataNotEmpty() throws Exception {
		...
		System.out.println("searchUserssss" + searchUser);
		userResponseList = userService.searchUsers(searchUser);
	...
	public void testAddUserValidData() throws Exception {
		...
		thrown = userService.add(addUser);
		assertTrue(thrown);
	...
	public void testAddUserNotValidData() throws Exception {
		...
		boolean thrown;
		thrown = userService.add(addUserUnvalid);
		assertTrue(thrown);
	...
	public void testEditUserValidData() throws Exception {
		...
		boolean thrown;
		thrown = userService.edit(updateUser);
		assertTrue(thrown);
	...
	public void testEditUserNotValidData() throws Exception {
		...
		boolean thrown;
		thrown = userService.edit(updateUserUnvalid);
		assertTrue(thrown);
	}
	...
	public void testDeleteUserValidData() throws Exception {
		...
		boolean thrown;
		thrown = userService.delete(deleteIdValid);
		assertTrue(thrown);
	}
	...
	public void testDeleteUserNotValidData() throws Exception {
		...
		boolean thrown;
		thrown = userService.delete(deleteIdInValid);
		assertTrue(thrown);
